...
app.post('/data/score', function (request, response) {
...
app.get('/data/score', function (request, response) {
...
app.post('/data/score2', function (request, response) {
...
app.get('/data/score2', function (request, response) {
...
app.post('/data/acc', function(request, response) {
    const data = request.body;
...
app.get('/data/acc', function(request, response) {
